...
namespace TechStore.Service.Implementations
{
    ...
    //    public ProductServicee(IUnitOfWork uow, SequenceGeneratorService sequenceService)
    //    {
    //        _uow = uow;
    ...
    //        serviceResult.Data = product.ToProductDetail(product.Category, product.Brand);
    //        serviceResult.Message = Messenger.GetDataSuccessful;
    ...
    //    public async Task<ServiceResult<string>> AddProduct(ProductCreateModell model)
    //    {
